...
uk-border-rounded-large uk-width-1-1 uk-height-xlarge uk-flex uk-flex-middle uk-flex-center" style={{backgroundImage: 'url(https://source.unsplash.com/7MAjXGUmaPw/600x700)'}}>
        <div className="uk-padding-large">
          ...
          <div className="uk-width-1-1 uk-text-center">
            <a href="sign-up.html" className="uk-button uk-button-primary uk-button-large">Sign Up</a>
          </div>
        </div>
      </div>
    </div>
